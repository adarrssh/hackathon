        ...
        <>
            ...
            >
                ...
                >
                    <Container
                        disableGutters
                        sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', height: '228px', marginLeft: '100px' }}
                    >
                        <div
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <img style={{ position: 'absolute', bottom: "2px", left: "5px" }} src={rectangle} alt="" />
                        </Container>
                        <Container
                            sx={{
